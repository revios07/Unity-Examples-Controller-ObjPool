...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
	//You Can Close Inputs With GameManager
    ...
    {
	//You Can Stop Game With Game Manager
        ...
        {
            _childAngleY += _xInput * 10f;
            _childAngleY = Mathf.Clamp(_childAngleY, -35f, 35f);
        }
        else
        {
            _childAngleY = Mathf.Lerp(_childAngleY, 0f, 6f * Time.fixedDeltaTime);
        }
